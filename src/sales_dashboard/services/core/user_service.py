...
from sales_dashboard.services.interfaces import UserServiceInterface, AuthServiceInterface

class UserService(UserServiceInterface):
    """User management service - focused on CRUD operations"""

    def __init__(self, user_repo: UserRepository, auth_service: AuthServiceInterface) -> None:
